        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="admin/save.html" type="post" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input name="userPswd" type="text" class="form-control" id="exampleInputPassword" placeholder="请输入登录密码">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUserName">用户昵称</label>
                            <input name="userName" type="text" class="form-control" id="exampleInputUserName" placeholder="请输入用户名称">
                        </div>
                        <div class="form-group">
